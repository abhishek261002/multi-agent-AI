...
import { addMessage, setIsLoading, setMessages } from "../redux/messageSlice.js";
...
export default function ChatInput({ setBanner }) {
  ...
  const handleSendMessage = async () => {
    ...
    try {
        ...
        // Push the assistant response state back to Redux
...
const handleSend = async () => {
    ...
    try {
      ...
      const data = await sendMessage(payload);
      console.log("Response data from agent service:", data);
      ...
      console.error("Failed to post prompt workflow:", error);
      setBanner({
        open: true,
