...
export default function Sidebar() {
  ...
  const handleSelectConversation = async(chat)=>{
    dispatch(setSelectedConversations(chat))
  }
  const PanelIcon = () => (
          ...
          return (
            <div
              ...
              className={`flex items-center gap-2.5 cursor-pointer mb-0.5 px-3 py-2.5 rounded-[10px] border transition-colors duration-150
                ${isActive ? "bg-indigo-500/40 border-indigo-500/[0.18]"
            ...
            >
              ...
              <p className={`text-[13px] font-medium truncate text-slate-100 ${isActive ? "text-slate-100" : "text-slate-300"}`}>
